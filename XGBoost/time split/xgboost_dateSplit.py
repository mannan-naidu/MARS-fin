...
def predict_stock_with_xgboost_gpu(file_path, results_dir):
    ...
    try:
        ...
        if X_test.empty or X_train.empty:
            print(f"  - WARNING: Not enough data to perform a train/test split at {split_date}. Skipping.")
            return None
        # --- END EDIT ---
    ...
    if not os.path.isdir(data_folder):
        ...
        if not files_to_process:
            ...
            if rmse_results:
                ...
                output_csv_path = os.path.join(results_folder, 'all_rmse_results_xgboost_time_split.csv')
